...
const defaultOptions = {
  ...
  standardFontDataUrl: {
    value: URL_ASSET + "/web/standard_fonts/",
    kind: OptionKind.API
  },
  verbosity: {
    value: 1,
  ...
  workerSrc: {
    value: URL_ASSET + "/build/pdf.worker.js",
    kind: OptionKind.WORKER
  }
};
{
  ...
  defaultOptions.sandboxBundleSrc = {
    value: URL_ASSET + "/build/pdf.sandbox.js",
    kind: OptionKind.VIEWER
  };
}
...
if (typeof window !== "undefined" && window["pdfjs-dist/build/pdf"]) {
  ...
  pdfjsLib = require(URL_ASSET + "/build/pdf.js");
}
