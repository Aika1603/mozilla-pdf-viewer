...
<html dir="ltr" lang="en" mozdisallowselectionprint>
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/pdfjs/web/viewer.css') }}">

    <link rel="resource" type="application/l10n" href="{{ asset('assets/pdfjs/web/locale/locale.properties') }}">
  <script src="{{ asset('assets/pdfjs/build/pdf.js') }}"></script>

  <script>
     const FILE_PDF = "{{ request()->input('file') }}" ;
     const URL_ASSET = "{{ asset('assets/pdfjs') }}" ;
  </script>
  <script src="{{ asset('assets/pdfjs/web/viewer.js') }}"></script>
